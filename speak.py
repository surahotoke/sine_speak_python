...
phonemes = {
    ...
    'ん': [[-39, 106], [-41, 212], [-43, 318], [-47, 424], [-64, 530], [-65, 636], [-67, 742], [-70, 848], [-72, 954], [-70, 1060], [-73, 1166], [-76, 1272], [-70, 1378], [-68, 1484], [-71, 1590], [-79, 1696], [-83, 1802], [-78, 1908], [-77, 2014], [-75, 2120], [-79, 2226], [-80, 2332], [-75, 2438], [-79, 2544]]
}
# 合成音ルール
compound_phonemes = {
    'な': ['ん', 'あ'],
